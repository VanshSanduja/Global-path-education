  ...
  const benefits = [
    {
      ...
      description: "Reduce your degree duration with RPL credits",
    },
    {
      title: "Cost Savings",
      icon: <Award className="text-red-600" size={24} />,
      description: "Lower tuition fees through credit recognition",
    },
    {
      title: "Global Recognition",
      icon: <Globe className="text-red-600" size={24} />,
      description: "Credits accepted by leading institutions",
    },
  ];
    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="mb-12 flex items-center justify-center">
          ...
          <h3 className="text-red-600 font-semibold tracking-wider uppercase text-3xl">
            Our Mission
          </h3>
          ...
          <div className="w-full lg:w-[50%] px-4">
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 shadow-lg mb-8">
              <p className="text-base md:text-lg text-gray-700 leading-relaxed">
                We specialize in assisting students who have completed{" "}
                <span className="text-red-500">
                  Singapore based qualifications
                </span>{" "}
                such as diplomas, advanced diplomas, or other recognized
                credentials and wish to advance their studies abroad or locally.
                Our team of experienced education consultants works closely with
                you to identify the best universities and programs that align
                with your academic background, career aspirations, and personal
                goals. Whether you dream of studying at a prestigious
                institution in Australia, United Kingdom, Canada, United States,
                New Zealand, Malaysia or even within Singapore, we make the
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-wrap gap-2">
                {destinations.map((destination, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-1 bg-blue-200 text-blue-950 px-3 py-1 rounded-full text-sm font-medium"
                  >
                    {destination.icon}
                    {destination.name}
                  </div>
          ...
          <div className="w-full lg:w-[60%] px-4">
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 shadow-lg mb-8">
              <p className="text-base md:text-lg text-gray-700 leading-relaxed mb-6">
                One of our key offerings is leveraging the Recognition of Prior
                Learning (RPL) credit system to accelerate your academic
                journey. The RPL system evaluates your prior qualifications,
                skills, and experiences to grant course credits, significantly
                reducing the duration of your degree or diploma program. This
                means you can achieve your educational goals faster, save on
                tuition fees, and enter the workforce sooner. Our experts
                navigate the complexities of RPL assessments, ensuring your
                credits are maximized and recognized by leading institutions
                worldwide.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#ffb0b0] to-white rounded-xl p-6 text-gray-700 shadow-lg">
              <p className="text-xl">
                We work hand in hand with various institutions in Singapore and
                universities worldwide to select the best programmes to meet
                your needs.
              </p>
              <Link
                to="/contact"
